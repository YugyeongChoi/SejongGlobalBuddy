    ...
    return (
        <div className="buddy-container">
            ...
            <div className="buddy-grid">
                ...
                <div className="buddy-card smallgroup">
                    ...
                    <p className="sub-info">
                        ...
                        *한국인 소모임 공동 개최 금지<br/>
                        *소모임에 자신의 버디가 포함되어도 먼슬리버디 인증 불가능<br/>
                        *필수 소모임은 버디크로스 인증 불가능
                    </p>
                </div>

                <div className="buddy-card cross">
                    <h3>버디크로스</h3>
                    <h4>자신의 담당 버디를 제외한 교환학생들과 교류하며 점수를 얻는 활동</h4>
                    <p><strong>대상</strong><br/>담당 버디를 제외한 교환학생</p>
                    <p><strong>인증 기준</strong><br />
            ...
            <div className="buddy-footer-info">
                <span className="highlight">인증 필수 활동: 먼슬리버디 3회, 소모임 1회</span><br />
