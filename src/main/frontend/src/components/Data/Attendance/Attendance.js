        ...
        <div className="container">
            <section className="section">
                ...
                <div className="rule-box">
                    <div className="box merit">
                        ...
                        <ul>
                            <li>예: 캠퍼스투어 참여자, 공식행사 진행 봉사자, 자율적인 소모임 개최자 등</li>
                        </ul>
                    ...
                    <div className="box demerit">
                        ...
                        <ul>
                            ...
                            <li>아래에 명시된 인정사유 외에는 제출하더라도 <strong>미인정</strong></li>
                        </ul>
                    </div>
                </div>
                <div className="notice">
                    <p>*최종 상벌점 기준, 벌점 1점 당 4000원 차감 후 회비 환급</p>
            ...
            <section className="section">
                ...
                <div className="attendance-box">
                    ...
                    <ul>
                        <li>사유서: 공식 행사 or (공식 회의) <strong>공지일 D-2</strong></li>
                        <li>증빙서류: 공식 행사 or (공식 회의) <strong>당일 D+2</strong></li>
